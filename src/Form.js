...
export class Form extends Component {
  ...
  render() {
    ...
    <form>
        ...
        <input type='text' id='name' placeholder="YOUR NAME" name='name' onChange={this.handelChange} value={this.state.name}/>
        <br/>
        <lable htmlfor='dept'><b> Department:</b></lable>
        <input type='text' id='dept' name='dept' placeholder='DEPARTMENT' onChange={this.handelChange}  value={this.state.dept}/>
        <br/>
        <lable htmlfor='rating'> <b>Rating:</b></lable>
        <input type='number' id='rating' name='rating' onChange={this.handelChange}  value={this.state.rating}/>
        <br/>
